export default class BuilderList {
  ...
  createSong(isPlaylist, isFavorite, index) {
    ...
    <li class="musicList__item">
      ...
      <button class="musicList__items--play musicList__items cursor"><img id="song-${index}" data-index="${index}" class="musicList__play--img js--listening" data-audio="${this.audio}"  data-name="${this.name}" src="./img/play-button.png" alt=""></button>
