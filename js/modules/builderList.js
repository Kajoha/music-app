export default class BuilderList {
  ...
  createSong(isPlaylist) {
    ...
    <li data-id="${this.id}" class="musicList__item">
      ...
      <button class="musicList__items--play musicList__items js--listening cursor"><img class="musicList__play--img" data-audio = "${this.audio}" src="./img/play-button.png" alt=""></button>
      <button class="musicList__items--like musicList__items  cursor"><img src="./img/hearth.png" alt=""></button>
